...
* [Prérequis](#prérequis)
  ...
  * [Envcironnement virtuel](#création-de-lenvrionnement-virtuel-img-srchttpsimgurcomxbg59oapng-height20)
...
Si vous ne possedez pas de serveur sur lequel vous conn XAMPP est nécessaire, mais uniquement pour faire tourner la base de donnée. Ainsi, il suffit seulement
de lancer MySql.
